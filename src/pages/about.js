  ...
  <MainWrapper>
    <ContentColumn>
      ...
      <Text>
        ...
        <br />
        <br /> When it comes to my free time; I’m spending most of it working on
        my Javascript skills, developing single page applications using React,
        and I also have experience with Angular 2+ and Vue.js. <br /> <br />
        When I’m not coding; I love reading about web development on Twitter and
        Medium, listening to about 20 different podcasts and when I want to take
        a break from programming altogether, I love watching sports (Arsenal FC
        and Detroit Pistons are my 2 favorite professional teams) or working out
        in the gym. <br />
